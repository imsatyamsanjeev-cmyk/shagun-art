...
const Gallery = () => {
  ...
  const galleryItems = [
    ...
    {
      id: 2,
      title: 'Mythology Sleeve & Portrait',
      image: '/Assets/Tattoo Designs/1000138542.jpg',
      categories: ['Portrait', 'Japanese', 'Black & Grey', 'Sleeve'],
      size: 'wide',
    },
    {
      id: 3,
      title: 'Ornate Peacock Linework',
    ...
    {
      id: 7,
      title: 'Tattoo Artist Drafting Studio',
      image: '/Assets/Tattoo Designs/1000138540.jpg',
      categories: ['Portrait', 'Black & Grey'],
      size: 'wide',
    },
  ];
